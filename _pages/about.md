...
- [Jun, 2024] The paper "Ultra-secure storage and analysis of genetic data for the advancement of precision medicine" is uploaded on [Biorxiv](https://www.biorxiv.org/content/10.1101/2024.06.14.599105v1).
...
- [Apr, 2024] Presented a poster "Ultra‑Secure Storage and Analysis of Genetic Data for the Advancement of Precision Medicine" at *RECOMB 2024* (MA, United States).

- [Oct, 2023] Gave a talk "Introduction to Neural Networks: Theory and Implementation" at *Korea Institute for Advanced Study (KIAS)* (Seoul, Korea).

- [Apr, 2023] Gave a talk "Homomorphic Encryption and Applications" at *Hanyang University* (Seoul, Korea).
...
- [Aug, 2021] Gave a talk "Private AI and Homomorphic Encryption" at *Samsung SDS* (Online).
...
- [Jul, 2020] Gave a talk "Basics of Homomorphic Encryption" at *National Tax Service* (Sejong, Korea). -->
